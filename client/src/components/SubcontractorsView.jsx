  ...
  return (
    <>
      ...
      <div className="slide-over glass"
        style={{ position: 'fixed', top: 'calc(64px + var(--space-md))', right: 'var(--space-md)', bottom: 'var(--space-md)', width: 480, maxWidth: '90vw', borderRadius: '20px / 18px', padding: 'var(--space-2xl)', zIndex: 101, display: 'flex', flexDirection: 'column', gap: 'var(--space-xl)' }}>
