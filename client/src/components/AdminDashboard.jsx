...
import { ChartBarIcon, ShieldCheckIcon, ChevronRightIcon, ChevronDownIcon, MagnifyingGlassIcon } from '@heroicons/react/24/outline';
...
function IconShield(props) {
  return <ShieldCheckIcon width={18} height={18} {...props} />;
}

function IconChevronRight(props) {
  return <ChevronRightIcon width={14} height={14} {...props} />;
}

function IconChevronDown(props) {
  return <ChevronDownIcon width={14} height={14} {...props} />;
}
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-lg)' }}>
      ...
      <div style={{ display: 'flex', gap: 'var(--space-md)', alignItems: 'center' }}>
        <div style={{ position: 'relative', flex: 1, maxWidth: 360 }}>
          ...
          />
          <MagnifyingGlassIcon style={{ width: 14, height: 14, position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: 'var(--text-muted)', pointerEvents: 'none' }} />
        </div>
