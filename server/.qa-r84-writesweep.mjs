...
const IDS = JSON.parse(fs.readFileSync('C:/tmp/qa-r84-ids.json','utf8'));
...
const P = JSON.parse(fs.readFileSync('C:/tmp/qa-r84-pmap.json','utf8'));
...
fs.writeFileSync('C:/tmp/qa-r84-write-results.json', JSON.stringify(results, null, 1));
const by = {};
